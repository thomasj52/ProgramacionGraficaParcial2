	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float smoothstepResult12 = smoothstep( 0.35 , 0.5 , distance( appendResult9 , _CenterL1 ));
				float smoothstepResult13 = smoothstep( 0.35 , 0.5 , distance( appendResult9 , _CenterR1 ));
...
/*ASEBEGIN
Version=18900
0;843;1954;508;2301.012;99.73392;1.742878;True;False
...
Node;AmplifyShaderEditor.SmoothstepOpNode;12;-545.4652,263.54;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.35;False;2;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;13;-551.4144,516.6212;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.35;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMinOpNode;15;-352.8213,376.0931;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=779D684AC3FC529F5EBD460D81498E1D3E47FBAF