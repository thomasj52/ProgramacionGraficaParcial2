...
Shader "FlashBang"
{
	Properties
	{
		...
		_FlashAmount("_FlashAmount", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 color2 = IsGammaSpace() ? float4(1,1,1,0.003921569) : float4(1,1,1,0.003921569);
				float4 lerpResult4 = lerp( tex2D( _MainTex, uv_MainTex ) , color2 , _FlashAmount);
...
/*ASEBEGIN
Version=18900
343;73;1013;498;1103.894;332.6307;1.3;True;False
...
ASEEND*/
//CHKSM=7679F56010AAABD6FD3C7D3048437F8DA63D1F78